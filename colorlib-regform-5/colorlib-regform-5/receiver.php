        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">RECEIVER Registation Form</h2>
                </div>
                <div class="card-body">
                    <form method="POST">
...
$userselect="select * from reciver where enail='$email' or phone='$phone'";
...
if($ucount>0)
{
    ...
    $insert="INSERT INTO reciver(firstname, lestname, enail, areacode, phone, bloodgr, age) VALUES ('$firstname', '$lastname', '$email', '$area_code', '$phone', '$blood', '$age')";
